...
namespace StringManipulationChallenge
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            string upperCase = Program.StringToUpper("yaas queen");
                Console.WriteLine(upperCase);
            string lowerCase = Program.StringToLower("HELLO");
        ...
        /// 2) return the new string.
        /// HINT: When getting input from the user (you are the user), 
        /// try inputting "   a string with whitespace   " to see how the whitespace is trimmed.
        /// </summary>
